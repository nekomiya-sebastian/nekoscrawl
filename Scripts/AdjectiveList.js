class AdjectiveList extends ItemList
{
	constructor()
	{
		super()
		...
		[
			...
			"Tasty","Hungry","Gooey","Juicy","Aqueous","Gelatinous","Slushy","Slimy","Squishy",
			"Hairy","Bristly",
			"Bouncy","Slippery",
			"Optimal","Opulent","Luxurious","Sprawling","Ornate","Regal",
			"Odd","Creepy","Unusual","Isolated","Crazy",
		]
	}
}